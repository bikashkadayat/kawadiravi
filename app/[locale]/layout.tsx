      ...
      <body className="bg-background text-foreground flex min-h-dvh flex-col antialiased">
        <NextIntlClientProvider>
          <ThemeProvider>
            ...
            <a
              href="#main"
              className="bg-accent focus:ring-primary-700 sr-only rounded-full px-4 py-2 font-semibold text-neutral-950 focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[70] focus:ring-2"
            >
              {t('skipToContent')}
            </a>
